...
export const COMMON_EQUIPMENT = [
  ...
  { id: 'neck_relic', name: '遠古聖物', icon: '🔮', slot: 'necklace', category: 'common', rarity: 'legendary', requiredStage: 3, price: 1500, bonusType: 'exp', bonusValue: 20, description: '經驗值 +20%' },
  // 翅膀 (wings)
  ...
  { id: 'weapon_staff', name: '賢者之杖', icon: '🔱', slot: 'weapon', category: 'common', rarity: 'legendary', requiredStage: 3, price: 2000, bonusType: 'exp', bonusValue: 30, description: '經驗值 +30%' },
];
...
export const EXCLUSIVE_EQUIPMENT = [
  { id: 'excl_young_scale', name: '龍鱗護符', icon: '🐉', slot: 'necklace', category: 'exclusive', rarity: 'legendary', requiredStage: 3, price: 0, bonusType: 'stars', bonusValue: 15, description: '幼鱗專屬·星星 +15%', exclusiveSpecies: 'young_scale' },
  { id: 'excl_jellyfish', name: '深海之心', icon: '🫧', slot: 'necklace', category: 'exclusive', rarity: 'legendary', requiredStage: 3, price: 0, bonusType: 'exp', bonusValue: 15, description: '水母專屬·經驗 +15% + 餵食增強', exclusiveSpecies: 'jellyfish', specialEffect: 'feed_boost' },
  { id: 'excl_ore_giant', name: '礦石核心', icon: '⛏️', slot: 'weapon', category: 'exclusive', rarity: 'legendary', requiredStage: 3, price: 0, bonusType: 'stars', bonusValue: 12, description: '礦石巨人專屬·星星 +12%', exclusiveSpecies: 'ore_giant' },
  { id: 'excl_jungle_cub', name: '叢林牙爪', icon: '🐾', slot: 'weapon', category: 'exclusive', rarity: 'legendary', requiredStage: 3, price: 0, bonusType: 'exp', bonusValue: 18, description: '叢林幼獸專屬·經驗 +18%', exclusiveSpecies: 'jungle_cub' },
  { id: 'excl_snow_beast', name: '極光項圈', icon: '🌌', slot: 'necklace', category: 'exclusive', rarity: 'legendary', requiredStage: 3, price: 0, bonusType: 'stars', bonusValue: 12, description: '雪原獸專屬·星星 +12%', exclusiveSpecies: 'snow_beast' },
  { id: 'excl_circuit_fish', name: '電路晶片', icon: '💻', slot: 'hat', category: 'exclusive', rarity: 'legendary', requiredStage: 3, price: 0, bonusType: 'exp', bonusValue: 18, description: '電路魚專屬·經驗 +18%', exclusiveSpecies: 'circuit_fish' },
  { id: 'excl_clockwork_bird', name: '精密齒輪', icon: '⚙️', slot: 'wings', category: 'exclusive', rarity: 'legendary', requiredStage: 3, price: 0, bonusType: 'stars', bonusValue: 8, description: '發條鳥專屬·星星 +8% + 計時器 +5 秒', exclusiveSpecies: 'clockwork_bird', specialEffect: 'time_extend_5' },
  // 傳說寵物套裝（3 隻，各 4 件）
  // 天空幼龍套裝
  { id: 'excl_sky_dragon_hat', name: '天空之冠', icon: '☁️', slot: 'hat', category: 'exclusive', setId: 'sky_dragon', rarity: 'legendary', requiredStage: 4, price: 0, bonusType: 'exp', bonusValue: 22, description: '天空幼龍專屬·經驗 +22%', exclusiveSpecies: 'sky_dragon' },
  { id: 'excl_sky_dragon_neck', name: '龍焰項鍊', icon: '🔥', slot: 'necklace', category: 'exclusive', setId: 'sky_dragon', rarity: 'legendary', requiredStage: 4, price: 0, bonusType: 'exp', bonusValue: 15, description: '天空幼龍專屬·經驗 +15%', exclusiveSpecies: 'sky_dragon' },
  { id: 'excl_sky_dragon_wings', name: '烈風之翼', icon: '🌪️', slot: 'wings', category: 'exclusive', setId: 'sky_dragon', rarity: 'legendary', requiredStage: 4, price: 0, bonusType: 'stars', bonusValue: 15, description: '天空幼龍專屬·星星 +15%', exclusiveSpecies: 'sky_dragon' },
  { id: 'excl_sky_dragon_weapon', name: '炎龍之牙', icon: '🔥', slot: 'weapon', category: 'exclusive', setId: 'sky_dragon', rarity: 'legendary', requiredStage: 4, price: 0, bonusType: 'stars', bonusValue: 22, description: '天空幼龍專屬·星星 +22%', exclusiveSpecies: 'sky_dragon' },
  // 水晶獸套裝
  ...
  { id: 'excl_nebula_fish_neck', name: '星雲核心', icon: '🌠', slot: 'necklace', category: 'exclusive', setId: 'nebula_fish', rarity: 'legendary', requiredStage: 4, price: 0, bonusType: 'exp', bonusValue: 25, description: '星雲魚專屬·經驗 +25%', exclusiveSpecies: 'nebula_fish' },
  { id: 'excl_nebula_fish_wings', name: '星塵之翼', icon: '✨', slot: 'wings', category: 'exclusive', setId: 'nebula_fish', rarity: 'legendary', requiredStage: 4, price: 0, bonusType: 'stars', bonusValue: 12, description: '星雲魚專屬·星星 +12%', exclusiveSpecies: 'nebula_fish' },
  { id: 'excl_nebula_fish_weapon', name: '彗星之杖', icon: '☄️', slot: 'weapon', category: 'exclusive', setId: 'nebula_fish', rarity: 'legendary', requiredStage: 4, price: 0, bonusType: 'exp', bonusValue: 15, description: '星雲魚專屬·經驗 +15%', exclusiveSpecies: 'nebula_fish' },
];
