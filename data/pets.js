...
export const PET_STAGES = {
  spirit_dog: {
    shared: [
      ...
      { stage: 2, name: '絨絨犬', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '輝樂狼', minLevel: 22 },
      { stage: 4, name: '聖光麒麟犬', minLevel: 40 },
      { stage: 5, name: '最終聖光麒麟犬', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '影爪狼', minLevel: 22 },
      { stage: 4, name: '月蝕狼人', minLevel: 40 },
      { stage: 5, name: '最終月蝕狼人', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  chick_bird: {
    shared: [
      ...
      { stage: 2, name: '雲雀寶寶', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '雷雲鷹', minLevel: 22 },
      { stage: 4, name: '嘉雷鵬王', minLevel: 40 },
      { stage: 5, name: '最終嘉雷鵬王', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '霜翼鴞', minLevel: 22 },
      { stage: 4, name: '極地冰鳳', minLevel: 40 },
      { stage: 5, name: '最終極地冰鳳', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  young_scale: {
    shared: [
      ...
      { stage: 2, name: '黏黏泥鰻', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '激流海蛇', minLevel: 22 },
      { stage: 4, name: '深海滄龍', minLevel: 40 },
      { stage: 5, name: '最終深海滄龍', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '沼澤巨蛙', minLevel: 22 },
      { stage: 4, name: '劇毒沼王', minLevel: 40 },
      { stage: 5, name: '最終劇毒沼王', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  beetle: {
    shared: [
      ...
      { stage: 2, name: '硬殼幼蟲', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '武士蟑', minLevel: 22 },
      { stage: 4, name: '鋼鐵大獨角仙', minLevel: 40 },
      { stage: 5, name: '最終鋼鐵獨角仙', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '幻夢蛾', minLevel: 22 },
      { stage: 4, name: '星雲皇蛾', minLevel: 40 },
      { stage: 5, name: '最終星雲皇蛾', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  electric_mouse: {
    shared: [
      ...
      { stage: 2, name: '微電鼠', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '數據鼠', minLevel: 22 },
      { stage: 4, name: '賽博黑麥鼠', minLevel: 40 },
      { stage: 5, name: '最終量子主機鼠', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '孢子鼠', minLevel: 22 },
      { stage: 4, name: '蘑菇發電鼠', minLevel: 40 },
      { stage: 5, name: '最終真菌雷神鼠', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  hard_crab: {
    shared: [
      ...
      { stage: 2, name: '小石蟹', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '熔岩蟹', minLevel: 22 },
      { stage: 4, name: '火山壘疊蟹', minLevel: 40 },
      { stage: 5, name: '最終熔岩巨像蟹', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '深海發光蟹', minLevel: 22 },
      { stage: 4, name: '煙霧安康蟹', minLevel: 40 },
      { stage: 5, name: '最終深淵海溝蟹', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  mimic_lizard: {
    shared: [
      ...
      { stage: 2, name: '變色小蜥', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '幻影蜥', minLevel: 22 },
      { stage: 4, name: '鏡像魔蜥', minLevel: 40 },
      { stage: 5, name: '最終虛空幻象龍', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '格鬥蜥', minLevel: 22 },
      { stage: 4, name: '武術大師蜥', minLevel: 40 },
      { stage: 5, name: '最終宗師門戰龍', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  seed_ball: {
    shared: [
      ...
      { stage: 2, name: '奇異種子', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '太陽花苞', minLevel: 22 },
      { stage: 4, name: '光合向日葵', minLevel: 40 },
      { stage: 5, name: '最終太陽神木精', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '寄生蘑蔓', minLevel: 22 },
      { stage: 4, name: '吸血荊棘怪', minLevel: 40 },
      { stage: 5, name: '最終腐朽魔花君主', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  jellyfish: {
    shared: [
      ...
      { stage: 2, name: '軟綿水母', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '光輝水母', minLevel: 22 },
      { stage: 4, name: '聖潔水母', minLevel: 40 },
      { stage: 5, name: '最終治癒海靈', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '劇毒水母', minLevel: 22 },
      { stage: 4, name: '腐蝕水母', minLevel: 40 },
      { stage: 5, name: '最終深淵毒皇', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  ore_giant: {
    shared: [
      ...
      { stage: 2, name: '小石怪', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '鐵礦怪', minLevel: 22 },
      { stage: 4, name: '合金堡壘', minLevel: 40 },
      { stage: 5, name: '最終鋼鐵巨神', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '晶石怪', minLevel: 22 },
      { stage: 4, name: '雷電晶簇', minLevel: 40 },
      { stage: 5, name: '最終能量晶核', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  jungle_cub: {
    shared: [
      ...
      { stage: 2, name: '葉尾小獸', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '猛葉獸', minLevel: 22 },
      { stage: 4, name: '森之力士', minLevel: 40 },
      { stage: 5, name: '最終叢林霸主', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '擬態葉靈', minLevel: 22 },
      { stage: 4, name: '幽影樹靈', minLevel: 40 },
      { stage: 5, name: '最終森林魅影', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  sky_dragon: {
    shared: [
      ...
      { stage: 2, name: '幼龍寶寶', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '炎翼龍', minLevel: 22 },
      { stage: 4, name: '爆炎飛龍', minLevel: 40 },
      { stage: 5, name: '最終末日炎龍', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '暴風龍', minLevel: 22 },
      { stage: 4, name: '疾風天龍', minLevel: 40 },
      { stage: 5, name: '最終蒼穹風神', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  dune_bug: {
    shared: [
      ...
      { stage: 2, name: '沙塵幼蟲', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '岩甲蟻', minLevel: 22 },
      { stage: 4, name: '沙暴巨蜈蚣', minLevel: 40 },
      { stage: 5, name: '最終鋼鐵沙皇蟲', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '掘地蟲', minLevel: 22 },
      { stage: 4, name: '流沙蟻獅', minLevel: 40 },
      { stage: 5, name: '最終沙漠死神蠍', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  sonic_bat: {
    shared: [
      ...
      { stage: 2, name: '小耳蝠', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '共鳴蝠', minLevel: 22 },
      { stage: 4, name: '心靈聲波蝠', minLevel: 40 },
      { stage: 5, name: '最終超聲波女皇', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '毒牙蝠', minLevel: 22 },
      { stage: 4, name: '腐蝕音波蝠', minLevel: 40 },
      { stage: 5, name: '最終瘟疫夜魔蝠', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  snow_beast: {
    shared: [
      ...
      { stage: 2, name: '絨毛小怪', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '冰爪獸', minLevel: 22 },
      { stage: 4, name: '暴雪拳師', minLevel: 40 },
      { stage: 5, name: '最終絕對零度格鬥家', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '雪精靈', minLevel: 22 },
      { stage: 4, name: '冰晶舞者', minLevel: 40 },
      { stage: 5, name: '最終極光雪女皇', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  circuit_fish: {
    shared: [
      ...
      { stage: 2, name: '小銅魚', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '電流鰻', minLevel: 22 },
      { stage: 4, name: '高壓電鰻', minLevel: 40 },
      { stage: 5, name: '最終雪暴海龍王', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '裝甲魚', minLevel: 22 },
      { stage: 4, name: '深海潛艇魚', minLevel: 40 },
      { stage: 5, name: '最終機械海神鎧', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  mushroom: {
    shared: [
      ...
      { stage: 2, name: '小蘑菇', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '拳擊菇', minLevel: 22 },
      { stage: 4, name: '森林守護者', minLevel: 40 },
      { stage: 5, name: '最終森之蘑菇王', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '毒孢菇', minLevel: 22 },
      { stage: 4, name: '腐爛蘑菇怪', minLevel: 40 },
      { stage: 5, name: '最終瘟疫蘑菇皇', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  crystal_beast: {
    shared: [
      ...
      { stage: 2, name: '晶體寶寶', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '聖晶獸', minLevel: 22 },
      { stage: 4, name: '光輝獨角獸', minLevel: 40 },
      { stage: 5, name: '最終水晶天馬', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '影晶獸', minLevel: 22 },
      { stage: 4, name: '詛咒石像鬼', minLevel: 40 },
      { stage: 5, name: '最終黑曜石魔像', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  nebula_fish: {
    shared: [
      ...
      { stage: 2, name: '太空小魚', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '星系魚', minLevel: 22 },
      { stage: 4, name: '引力海龍', minLevel: 40 },
      { stage: 5, name: '最終宇宙鯨皇', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '黑洞', minLevel: 22 },
      { stage: 4, name: '吞噬海怪', minLevel: 40 },
      { stage: 5, name: '最終深淵星雲獸', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
  clockwork_bird: {
    shared: [
      ...
      { stage: 2, name: '機械雛鳥', minLevel: 8 },
    ],
    pathA: [
      { stage: 3, name: '時鐘鷹', minLevel: 22 },
      { stage: 4, name: '精密獵隼', minLevel: 40 },
      { stage: 5, name: '最終時間領主鳶', minLevel: 61 },
    ],
    pathB: [
      { stage: 3, name: '廢鐵鳥', minLevel: 22 },
      { stage: 4, name: '故障鳳凰', minLevel: 40 },
      { stage: 5, name: '最終末日機械鳥', minLevel: 61 },
    ],
    evolutionLevel: 22,
  },
};
...
export const getExpForLevel = (level, species) => {
  if (!species) return Math.round(level * 50 * (1 + level / 25));
  ...
  return Math.round(level * multiplier * (1 + level / 25));
};

// 舊線性公式（僅供遷移計算用）
export const getExpForLevelOld = (level, species) => {
  if (!species) return level * 50;
  const speciesInfo = PET_SPECIES.find(s => s.species === species);
  const rarity = speciesInfo?.rarity || 'normal';
  const multiplier = RARITY_EXP_MULTIPLIER[rarity] || 50;
